...
def produce_metrics(index_name):
    ...
    for topic in list(topics.items()):  # first 5 topics (change list indexes to alter)
        ...
        if topic_id == str(690):
            ...
            row_format = "{:27}{:8}{:8}{:11}{:8}{:8}{:11}{:8}{:8}{:11}{:8}{:8}{:11}"
            title = "{:27}{:27}{:27}{:27}{:27}"
            print(title.format('Topic ' + topic_id, 'Title', 'Description', 'Narrative',"expanded_description",))
            print("{:27}{:8}{:8}{:8}".format("","ave_p","prec","ndcg"))
